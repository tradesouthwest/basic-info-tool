...
class Basic_Info_Tool_Core {
	...
	public static function basic_debug_info( $html = true ) {
		...
		$versions      = array(
			...
			'Server Software'             => ( isset(  $_SERVER['SERVER_SOFTWARE'] ) ) : wp_unslash( $_SERVER['SERVER_SOFTWARE']) ? false,
			'Your User Agent'             => ( isset( $_SERVER['HTTP_USER_AGENT'] )) : wp_unslash( $_SERVER['HTTP_USER_AGENT']) ? false,
